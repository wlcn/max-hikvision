...
public interface HCNetSDK extends Library {
    ...
    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(StringUtils.join(ConfigUtil.getSdkConfig().getSdkPath(), File.separator, ConfigUtil.getSdkConfig().getSdkFile()), HCNetSDK.class);
    /***宏定义***/
    //常量
